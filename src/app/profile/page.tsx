      ...
      <div className="text-white">
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          ...
          <p className="text-gray-400 mb-6">
            Select laps to feature on your public profile. Others will be able to see these when viewing your racing achievements.
          </p>
          ...
          {allLaps.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-400 mb-4">Start racing to build your profile!</p>
            </div>
          ) : (
